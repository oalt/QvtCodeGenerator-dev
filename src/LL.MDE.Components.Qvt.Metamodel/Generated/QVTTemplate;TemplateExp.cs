...
namespace LL.MDE.Components.Qvt.Metamodel.QVTTemplate
{
    ...
    public abstract partial class TemplateExp : LiteralExp, ITemplateExp, IModelElement
    {
        ...
        public IVariable BindsTo
        {
            ...
            set
            {
                if ((this._bindsTo != value))
                {
                    ...
                    this.OnBindsToChanging(e);
                    this.OnPropertyChanging("BindsTo", e, _bindsToReference);
                    this._bindsTo = value;
                    if ((old != null))
                    {
                    ...
                    this.OnPropertyChanged("BindsTo", e, _bindsToReference);
                }
            }
        }
        ...
        public new static NMF.Models.Meta.IClass ClassInstance
        {
            get
            {
                ...
                {
                    _classInstance = ((NMF.Models.Meta.IClass)(MetaRepository.Instance.Resolve("http://www.omg.org/spec/QVT/20140401/QVTTemplate#//TemplateExp")));
                }
        ...
        /// </summary>
        public event System.EventHandler<ValueChangedEventArgs> BindsToChanging;
        
        /// <summary>
        /// Gets fired when the BindsTo property changed its value
        /// </summary>
        public event System.EventHandler<ValueChangedEventArgs> BindsToChanged;
        ...
        {
            return ((NMF.Models.Meta.ITypedElement)(((ModelElement)(LL.MDE.Components.Qvt.Metamodel.QVTTemplate.TemplateExp.ClassInstance)).Resolve("bindsTo")));
        }
        ...
        protected virtual void OnBindsToChanging(ValueChangedEventArgs eventArgs)
        {
            System.EventHandler<ValueChangedEventArgs> handler = this.BindsToChanging;
            if ((handler != null))
            {
        ...
        {
            System.EventHandler<ValueChangedEventArgs> handler = this.BindsToChanged;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
        ...
        {
            return ((NMF.Models.Meta.ITypedElement)(((ModelElement)(LL.MDE.Components.Qvt.Metamodel.QVTTemplate.TemplateExp.ClassInstance)).Resolve("where")));
        }
