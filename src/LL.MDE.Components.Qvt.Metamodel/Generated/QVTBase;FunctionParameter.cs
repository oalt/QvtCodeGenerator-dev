...
namespace LL.MDE.Components.Qvt.Metamodel.QVTBase
{
    ...
    public partial class FunctionParameter : Variable, IFunctionParameter, IModelElement
    {
        ...
        public override IEnumerableExpression<IModelElement> Children
        {
            get
            {
                return base.Children.Concat(new FunctionParameterChildrenCollection(this));
            }
        }
        ...
        public new static NMF.Models.Meta.IClass ClassInstance
        {
            get
            {
                ...
                {
                    _classInstance = ((NMF.Models.Meta.IClass)(MetaRepository.Instance.Resolve("http://www.omg.org/spec/QVT/20140401/QVTBase#//FunctionParameter")));
                }
        ...
        /// <summary>
        /// The collection class to to represent the children of the FunctionParameter class
        /// </summary>
        public class FunctionParameterChildrenCollection : ReferenceCollection, ICollectionExpression<IModelElement>, ICollection<IModelElement>
        {
            
            private FunctionParameter _parent;
            
            /// <summary>
            /// Creates a new instance
            /// </summary>
            public FunctionParameterChildrenCollection(FunctionParameter parent)
            {
                this._parent = parent;
            }
