...
namespace LL.MDE.Components.Qvt.Metamodel.EMOF
{
    ...
    public abstract partial class Type : NamedElement, LL.MDE.Components.Qvt.Metamodel.EMOF.IType, IModelElement
    {
        ...
        public new static NMF.Models.Meta.IClass ClassInstance
        {
            get
            {
                ...
                {
                    _classInstance = ((NMF.Models.Meta.IClass)(MetaRepository.Instance.Resolve("http://www.omg.org/spec/QVT/20140401/EMOF#//Type")));
                }
        ...
        {
            System.Func<LL.MDE.Components.Qvt.Metamodel.EMOF.IType, IObject, bool> handler = OperationBroker.Instance.GetRegisteredDelegate<System.Func<LL.MDE.Components.Qvt.Metamodel.EMOF.IType, IObject, bool>>(_isInstanceOperation);
            if ((handler != null))
            {
            }
            else
        ...
        {
            return ((NMF.Models.Meta.ITypedElement)(((ModelElement)(LL.MDE.Components.Qvt.Metamodel.EMOF.Type.ClassInstance)).Resolve("package")));
        }
        ...
        /// </summary>
        private sealed class PackageProxy : ModelPropertyChange<LL.MDE.Components.Qvt.Metamodel.EMOF.IType, IPackage>
        {
            ...
            public PackageProxy(LL.MDE.Components.Qvt.Metamodel.EMOF.IType modelElement) : 
