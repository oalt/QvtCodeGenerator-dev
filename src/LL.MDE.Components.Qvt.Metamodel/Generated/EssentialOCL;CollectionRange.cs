...
namespace LL.MDE.Components.Qvt.Metamodel.EssentialOCL
{
    ...
    public partial class CollectionRange : CollectionLiteralPart, ICollectionRange, IModelElement
    {
        ...
        private static Lazy<NMF.Models.Meta.ITypedElement> _lastReference = new Lazy<NMF.Models.Meta.ITypedElement>(RetrieveLastReference);
        ...
        public IOclExpression Last
        {
            ...
            set
            {
                if ((this._last != value))
                {
                    ...
                    ValueChangedEventArgs e = new ValueChangedEventArgs(old, value);
                    this.OnLastChanging(e);
                    this.OnPropertyChanging("Last", e, _lastReference);
                    this._last = value;
                    if ((old != null))
                    {
                        if ((old.Parent == this))
                        ...
                        old.ParentChanged -= this.OnResetLast;
                    }
                    if ((value != null))
                    {
                        value.Parent = this;
                        value.ParentChanged += this.OnResetLast;
                    }
                    this.OnLastChanged(e);
                    this.OnPropertyChanged("Last", e, _lastReference);
                }
            }
        }
        ...
        public new static NMF.Models.Meta.IClass ClassInstance
        {
            get
            {
                ...
                {
                    _classInstance = ((NMF.Models.Meta.IClass)(MetaRepository.Instance.Resolve("http://www.omg.org/spec/QVT/20140401/EssentialOCL#//CollectionRange")));
                }
        ...
        /// </summary>
        public event System.EventHandler<ValueChangedEventArgs> FirstChanging;
        
        /// <summary>
        /// Gets fired when the First property changed its value
        /// </summary>
        public event System.EventHandler<ValueChangedEventArgs> FirstChanged;
        
        /// <summary>
        /// Gets fired before the Last property changes its value
        /// </summary>
        public event System.EventHandler<ValueChangedEventArgs> LastChanging;
        
        /// <summary>
        /// Gets fired when the Last property changed its value
        /// </summary>
        public event System.EventHandler<ValueChangedEventArgs> LastChanged;
        
        private static NMF.Models.Meta.ITypedElement RetrieveFirstReference()
        {
            return ((NMF.Models.Meta.ITypedElement)(((ModelElement)(LL.MDE.Components.Qvt.Metamodel.EssentialOCL.CollectionRange.ClassInstance)).Resolve("first")));
        }
        ...
        protected virtual void OnFirstChanging(ValueChangedEventArgs eventArgs)
        {
            System.EventHandler<ValueChangedEventArgs> handler = this.FirstChanging;
            if ((handler != null))
            {
        ...
        {
            System.EventHandler<ValueChangedEventArgs> handler = this.FirstChanged;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
        ...
        private static NMF.Models.Meta.ITypedElement RetrieveLastReference()
        {
            return ((NMF.Models.Meta.ITypedElement)(((ModelElement)(LL.MDE.Components.Qvt.Metamodel.EssentialOCL.CollectionRange.ClassInstance)).Resolve("last")));
        }
        ...
        /// </summary>
        /// <param name="eventArgs">The event data</param>
        protected virtual void OnLastChanging(ValueChangedEventArgs eventArgs)
        {
            System.EventHandler<ValueChangedEventArgs> handler = this.LastChanging;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
        ...
        {
            System.EventHandler<ValueChangedEventArgs> handler = this.LastChanged;
            if ((handler != null))
            {
                handler.Invoke(this, eventArgs);
            }
