...
namespace LL.MDE.Components.Qvt.Metamodel.EMOF
{
    ...
    public partial class Comment : Element, IComment, IModelElement
    {
        ...
        [XmlAttributeAttribute(true)]
        [ConstantAttribute()]
        public ISetExpression<INamedElement> AnnotatedElement
        {
            get
            {
        ...
        public new static NMF.Models.Meta.IClass ClassInstance
        {
            get
            {
                ...
                {
                    _classInstance = ((NMF.Models.Meta.IClass)(MetaRepository.Instance.Resolve("http://www.omg.org/spec/QVT/20140401/EMOF#//Comment")));
                }
        ...
        {
            return ((NMF.Models.Meta.ITypedElement)(((ModelElement)(LL.MDE.Components.Qvt.Metamodel.EMOF.Comment.ClassInstance)).Resolve("body")));
        }
        ...
        {
            return ((NMF.Models.Meta.ITypedElement)(((ModelElement)(LL.MDE.Components.Qvt.Metamodel.EMOF.Comment.ClassInstance)).Resolve("annotatedElement")));
        }
