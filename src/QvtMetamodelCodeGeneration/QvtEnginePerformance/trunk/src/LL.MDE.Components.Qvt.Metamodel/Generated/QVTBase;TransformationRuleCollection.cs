...
namespace LL.MDE.Components.Qvt.Metamodel.QVTBase
{
    ...
    /// <summary>
    /// Denotes a class to implement the rule reference
    /// </summary>
    public class TransformationRuleCollection : ObservableOppositeOrderedSet<ITransformation, IRule>
    {
        ...
        protected override void SetOpposite(IRule item, ITransformation newParent)
        {
            if ((newParent != null))
            {
