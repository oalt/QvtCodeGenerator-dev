...
namespace LL.MDE.Components.Qvt.Metamodel.QVTRelation
{
    ...
    /// <summary>
    /// Denotes a class to implement the defaultAssignment reference
    /// </summary>
    public class RelationDomainDefaultAssignmentCollection : ObservableOppositeOrderedSet<IRelationDomain, IRelationDomainAssignment>
    {
        
        /// <summary>
        /// Creates a new instance
        /// </summary>
        /// <param name="parent">the parent RelationDomain</param>
        ...
        protected override void SetOpposite(IRelationDomainAssignment item, IRelationDomain newParent)
        {
            if ((newParent != null))
            {
