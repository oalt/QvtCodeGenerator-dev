...
namespace LL.MDE.Components.Qvt.EnArImport
{
    ...
    {
        private readonly Dictionary<string, EMOF.IPackage> elementToPackage = new Dictionary<string, EMOF.IPackage>();
        ...
        private List<string> ParseNamespace(string metamodelNamespace)
        {
            List<string> result = new List<string>();

            if (!string.IsNullOrWhiteSpace(metamodelNamespace))
            {
                string[] packageNames = metamodelNamespace.Split('.');
...
*/
        ...
        {
            return elementToPackage[p.PackageGUID];
        }
